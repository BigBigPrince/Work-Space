<template>
  <div class="container mx-auto p-4">
    ...
    <div class="flex justify-between items-center mb-8">
      <h1 class="text-2xl font-bold">资料查询平台</h1>
    ...
    <div v-if="favoriteWebsites.length > 0" class="mb-8">
      <h2 class="text-xl font-bold mb-4">收藏的资料库</h2>
    ...
    <!-- 常用资料库区域 -->
    <div>
      <h2 class="text-xl font-bold mb-4">学术资料库</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        <WebsiteCard
...
import websitesData from '@/assets/data/checking-websites.json'
...
function loadFavorites() {
  const saved = localStorage.getItem('checkingFavoriteWebsites')
  if (saved) {
...
function saveFavorites() {
  ...
  localStorage.setItem('checkingFavoriteWebsites', JSON.stringify(idsArray))
}
</script>
